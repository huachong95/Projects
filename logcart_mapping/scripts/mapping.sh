...
source ~/catkin_ws/devel/setup.bash & roslaunch freenect_launch & roslaunch logcart_driver logcart.sh & roslaunch logcart_mapping logcart_mapping.launch & roslaunch logcart_mapping pointcloudtolaserscan.launch
