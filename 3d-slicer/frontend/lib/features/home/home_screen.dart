            ...
            Wrap(
              ...
              children: [
                ...
                _ActionCard(
                  ...
                  onTap: () => context.push('/timelapse'),
                ),
                _ActionCard(
                  icon: Icons.history,
                  label: 'Print History',
                  description: 'Past prints & stats',
                  onTap: () => context.push('/history'),
                ),
                _ActionCard(
                  icon: Icons.straighten,
                  label: 'Filament',
                  description: 'Manage spool inventory',
                  onTap: () => context.push('/filament'),
                ),
                _ActionCard(
                  icon: Icons.notifications_outlined,
                  label: 'Notifications',
                  description: 'Telegram, Discord, webhooks',
